	...
	public void reduce(LongWritable key, Iterable<DoubleWritable> values,
       ...
       a=values.iterator().next().get();
		...
		else if((key.get()%4)==3) 
		{
			...
			multipleOutputs.write(txtkey,txtval,"/app/hadoop/temp/New_WithouMultilook_Interferometric_Magnitude_Slc1_slc2");
			phase=Math.atan2(imag, real);
			txtval.set(""+phase);	
			multipleOutputs.write(txtkey,txtval,"/app/hadoop/temp/New_WithouMultilook_Interferometric_Phase_Slc1_slc2");
