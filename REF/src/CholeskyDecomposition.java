 ...
 * @version $Id: CholeskyDecomposition.java 1244107 2012-02-14 16:17:55Z erans $
...
public class CholeskyDecomposition {
    ...
    public CholeskyDecomposition (final RealMatrix matrix,
        ...
        for (int i = 0; i < order; ++i) {
            ...
            ltI[i] = FastMath.sqrt(Math.abs(ltI[i]));//ara 7-2-2015 to remove NaN as sqrt of negative number comes NaN  
