	...
	import jdoris.Window;
	import jdoris.LinearAlgebraUtils;
	import jdoris.SarUtils;
	...
	public class PhaseFilter {
	    ...
	    public void filter() {
	     ...
	     LinearAlgebraUtils.setdata(outData, winFiltered, block, winBlock);
	         ...
	         //       LinearAlgebraUtils.setdata(data, winFiltered, block, winBlock);
	    ...
	    public static DoubleMatrix arrangeKernel2d(DoubleMatrix kernel2dIn, final double scaleFactor) {
	        ...
	        final int extraL = ((kernelLines)%2==0) ? 1 : 0; // 1 less to fill
	        final int extraP = ((kernelPixels)%2==0) ? 1 : 0; // 1 less to fill
